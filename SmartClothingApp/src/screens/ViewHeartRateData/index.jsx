    ...
    const fetchHeartRateData = async () => {
      try {
        ...
        if (result.length > 0) {
          ...
          console.log("[fetchHeartRateData] setMinHeartRate and setMaxHeartRate to min and max");
        } else {
        ...
        console.log("[fetchHeartRateData] setHeartRateData to result");
      } catch (error) {
...
//           console.log("[fetchHeartRateData] setMinHeartRate and setMaxHeartRate to null")
//         }
//         setHeartRateData(result);
//       } catch (error) {
