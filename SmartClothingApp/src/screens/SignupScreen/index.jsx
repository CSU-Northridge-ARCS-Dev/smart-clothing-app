            ...
            <View style={styles.modalView}>
              <ScrollView>
                ...
                <Text style={styles.modalText}>
                  ...
                  using the Smart Textile Clothing Devices App (the "App"),
                  which is designed to work with Hexoskin and Sensoria smart
                  devices and iOS and Android Apple Watches, to track body
                  metrics and provide data analytics. These Terms constitute a
                  legally binding agreement between you ("User," "you," or
                  "your") and CSUN ("Company," "we," "us," or "our"). By
                  downloading, accessing, or using the App, you agree to be
                  bound by these Terms. If you do not agree to these Terms, you
                  will not be allowed to use the app.
                </Text>
                ...
                <Text style={styles.modalText}>
                  ...
                  bound by these Terms, as well as any additional terms,
                  guidelines, and rules referenced herein or otherwise
                ...
                <Text style={styles.modalText}>
                  2.1 User Age: You must be at least 13 years old to use the
                  App. By using the App, you affirm that you meet this age
                  requirement.
                </Text>

                <Text style={styles.modalText}>
                  2.2 Device Compatibility: The App is designed to work with
                  Hexoskin and Sensoria smart devices and iOS/Android Smart
                  Watches. We are not responsible for any incompatibility issues
                  arising from the use of third-party devices.
                </Text>

                <Text style={styles.modalText}>
                  2.3 User Data: By using the App, you consent to the
                  collection, storage, and processing of your personal and
                  health-related data as described in our Privacy Policy. You
                  understand that the App requires access to certain device
                  features and data to function properly.
                </Text>

                <Text style={styles.modalText}>
                  2.4 Prohibited Use: You agree not to use the App for any
                  unlawful or unauthorized purpose. You shall not engage in any
                  activity that disrupts or interferes with the proper
                  functioning of the App or its associated services.
                </Text>

                <Text style={styles.modalTextTitle}>
                  {" "}
                  User Responsibilities: The user is responsible for assuring
                  that the data is available to the applicatoin
                </Text>

                <Text style={styles.modalText}>
                  3.1 Accuracy of Information: You are solely responsible for
                ...
                <Text style={styles.modalText}>
                  ...
                  provided by the App are for informational purposes only and
                  should not be considered a substitute for professional medical
                  advice. Consult a qualified healthcare professional before
                  making any health-related decisions based on the App's data.
                </Text>

                <Text style={styles.modalText}>
                  3.3 Assumption of Risk: You understand that using the App
                  involves inherent risks. You assume all risks associated with
                  using the App and its data.
                </Text>

                <Text style={styles.modalTextTitle}>Intellectual Property</Text>

                <Text style={styles.modalText}>
                  4.1 App Ownership: The App, including its design, graphics,
                  text, content, and all other components, is owned by the
                  Company or its licensors and is protected by copyright and
                ...
                <Text style={styles.modalText}>
                  ...
                  display, or perform the App except as expressly permitted by
                  these Terms.
                </Text>
                ...
                <Text style={styles.modalText}>
                  ...
                  the App, without notice, for any reason, including, but not
                  limited to, violation of these Terms or any applicable law.
                </Text>
                ...
                <Text style={styles.modalText}>
                  ...
                  do not warrant that the App will be error-free, uninterrupted,
                  secure, or suitable for your needs. We disclaim all
                ...
                <Text style={styles.modalText}>
                  ...
                  updated Terms on the App. Your continued use of the App after
                ...
                <Text style={styles.modalText}>
                  ...
                  with the laws of the State of California, USA. Any disputes
                ...
                <Text style={styles.modalText}>
                  If you have any questions about these Terms or the App, you
                  may contact us at ARCS.center
                </Text>

                <Text style={styles.modalText}>
                  By using the Smart Textile Clothing Devices App, you
