...
const NotificationPermissionsModal = ({ 
  ...
  const acceptAll = () => {
    const updatedPermissions = Object.keys(permissions).reduce((acc, coach) => {
      acc[coach] = true;
      return acc;
    }, {});
      ...
      <View style={styles.modalContent}>
        ...
        {coachName && (
          <View style={styles.permissionContainer}>
            ...
            <Switch
              value={permissions[coachName] || false}
              onValueChange={() => togglePermission(coachName)}
            />
          </View>
        )}
